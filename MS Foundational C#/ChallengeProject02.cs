...
{
    internal class ChallengeProject02
    {
            ...
            do
            {
                ...
                switch (menuSelection)
                {
                    ...
                    case "2":
                        ...
                        do
                        {                            
                            Console.WriteLine("Enter desired dog characteristics separated by ',' to search for (max 10)");
                            readResult = Console.ReadLine();
                            Console.WriteLine();

                            if(!string.IsNullOrWhiteSpace(readResult))
                            {
                                dogCharacteristics = readResult.Replace(" ", "").Split(',');
                                ...
                                for (int i = 0; i < maxPets; i++)
                                {
                                    bool dogCharacteristicFound = false;
                                    if (ourAnimals[i, 1].Contains("dog"))
                                    {
                                        ...
                                        foreach (string characteristic in dogCharacteristics)
                                        {
                                            if (dogDescription.Contains(characteristic))
                                            {
                                                ...
                                                dogCharacteristicFound = true;
                                                dogFound = true;
                                            }
                                        }

                                        if (dogCharacteristicFound)
                                        {                                          
                                ...
                                if (!dogFound)
                                    Console.WriteLine("No matches found for " + String.Join(", ", dogCharacteristics));
                            }  
                            else
                            {
                                dogCharacteristics = new string[0];
                                Console.WriteLine("You must enter at least one characteristic.");
                            }
